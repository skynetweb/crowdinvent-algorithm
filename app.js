...
var results = User.find({id: 2}).exec(function (err, users) {
    users.map(user => {
        ...
        "$addFields": {
            ...
            ideas.map(idea => {
                ...
                //
                ideaResults.push([{"score": score, "ideaId": idea.id, "followees": idea.isInFollowees, "interacted": idea.isInInteracted }]);
                //res.json();
                // if (score > 0.3) {
